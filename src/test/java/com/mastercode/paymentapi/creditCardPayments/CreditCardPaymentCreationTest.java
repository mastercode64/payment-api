...
public class CreditCardPaymentCreationTest {
	@Autowired
	...
	@Test
	public void createdCreditCardPaymentShouldExists() throws Exception {		
		...
		//Creating credit card payment request
